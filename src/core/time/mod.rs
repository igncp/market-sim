...
// Pure
impl TimeHandler {
    pub fn new(initial_time: u64, secs_factor: Option<u64>) -> Self {
        let millis_to_wait = 100;
    ...
    pub fn get_running_seconds(&self) -> u64 {
        let millis_span = self.time * self.millis_to_wait;
        let seconds_passed =
    ...
    pub fn get_now_unix_timestamp(&self) -> u64 {
        let factor = self.millis_to_wait as f64 / 1000.0;
